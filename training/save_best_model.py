...
def _get_artifacts_dirname(trained_data_class: str) -> Path:
    ...
    for keyword in ["line", "paragraph", "page"]:
...
def _setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--project", type=str, default="lab7")
    parser.add_argument("--trained_data_class", type=str, default="ChuNomOriginalAndSyntheticPages")
