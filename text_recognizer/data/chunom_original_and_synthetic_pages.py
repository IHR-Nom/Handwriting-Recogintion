...
class ChuNomOriginalAndSyntheticPages(BaseDataModule):
    ...
    def setup(self, stage: str = None) -> None:
        ...
        self.data_train = ConcatDataset([self.chunom_pages.data_train, self.chunom_syn_pages.data_train])
        self.data_val = ConcatDataset([self.chunom_pages.data_val, self.chunom_syn_pages.data_val])
        self.data_test = ConcatDataset([self.chunom_pages.data_test, self.chunom_syn_pages.data_test])
...
if __name__ == "__main__":
    load_and_print_info(ChuNomOriginalAndSyntheticPages)
