...
FINAL_IMAGE_HEIGHT = 776 // IMAGE_SCALE_FACTOR
FINAL_IMAGE_WIDTH = 1172 // IMAGE_SCALE_FACTOR
IMAGE_HEIGHT = 730 // IMAGE_SCALE_FACTOR
IMAGE_WIDTH = 1050 // IMAGE_SCALE_FACTOR
MAX_LABEL_LENGTH = 682

ESSENTIALS_FILENAME = Path(__file__).parents[0].resolve() / "chunom_characters.json"
